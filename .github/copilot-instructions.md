# Portfolio monorepo — AI coding rules
...
- **New chat:** paste from `docs/templates/SESSION_START_MONOREPO.md` or `SESSION_START_APP_CHANGE.md`; say *read `CLAUDE.md` and `HANDOFF.md` first*.
