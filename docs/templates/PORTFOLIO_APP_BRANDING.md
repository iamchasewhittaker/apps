...
| [`docs/templates/SESSION_START_CLARITY_IOS_LOGOS.md`](SESSION_START_CLARITY_IOS_LOGOS.md) | **Clarity iOS** — fix / iterate **one** launcher (suite shipped; name app in chat) |
