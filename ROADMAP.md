...
| 2026-04-13 | Clarity Time (iOS) | v0.1 | **App icon + branding:** timer-arc wide mockup → `AppIcon.png` 1024 + `Contents.json` filename; **`docs/BRANDING.md`**; `CLAUDE.md` branding + icon spec links | `portfolio/clarity-time-ios/` · `xcodebuild build` ClarityTime ✅ (same destination) |
