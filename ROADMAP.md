...
> Last updated: 2026-04-20 (Knowledge Base v2.1.1 — seed maintenance: My Projects URL fixes + Git/Vercel/Supabase folders) | Maintained by Chase
...
| 2026-04-20 | Knowledge Base | v2.1.1 | **Seed maintenance:** fixed 4 My Projects URLs (Shipyard → canonical alias, RollerTask Tycoon Web → canonical alias, Knowledge Base → GitHub link since Vercel removed, Summit Push renamed "Unnamed"); added Vercel folder (8 links) + Supabase folder (8 links) under Web & Dev; 4 Git links added to GitHub folder; Alias Ledger + Clarity Budget Web added to My Projects; SEED_VERSION 11 | `portfolio/knowledge-base/` |
