...
|------|-----|---------|----------------|-------|
| 2026-04-12 | Wellness Tracker + iOS | v15.10 / iOS | **Branding:** unified W + sunrise app mark on `#0d0d0f`; web PWA icons + `manifest.json` + `docs/BRANDING.md`; iOS `AppIcon.png` updated to match | See `portfolio/wellness-tracker/docs/BRANDING.md` |
