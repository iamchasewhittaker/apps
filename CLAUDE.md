...
| Job Search HQ (iOS)         | v0.1          | `chase_job_search_ios_v1`                                                                                                    | local Xcode                         | 🟡 Local · SwiftUI + ClarityUI · `[portfolio/job-search-hq-ios](portfolio/job-search-hq-ios)` · local-first MVP; Supabase Phase 2                                                                                         |
...
/portfolio/
  ...
  job-search-hq-ios/
    JobSearchHQ.xcodeproj, JobSearchHQ/  ← SwiftUI + ClarityUI; local-first MVP; Phase 2 Supabase (see docs/SYNC_PHASE2.md)
  app-forge/
    src/
