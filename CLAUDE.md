...
| Job Search HQ               | v8.11         | `chase_job_search_v1`                                                                                                        | job-search-hq.vercel.app            | ✅ Active · Wave 4 #4: offer comparison side-by-side (💰 OfferModal + best-in-column compare view) · outreach cadence timeline · Draft Message contact nav · Weekly Review tab · Chrome MV3 in `extension/`                |
