...
| Gmail Forge                 | v0.3          | Apps Script Script Properties (`CLASSIFIER_MODE`, `GEMINI_API_KEY`, `SHEET_ID`, `NEWSLETTER_TO_ALIASES`, `TRIGGER_TOKEN`)        | script.google.com                   | Archived 2026-04-23 · Replaced by Extra app · `[portfolio/archive/gmail-forge](portfolio/archive/gmail-forge)` |
...
| Gmail Forge | Tool | Archived — replaced by Extra app | — | — |
