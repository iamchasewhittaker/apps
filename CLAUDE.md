...
| Clarity Budget (web)        | v0.2          | `chase_budget_web_v1` + YNAB token key in `localStorage`                                                                                                                                 | local                               | ✅ Next.js STS dashboard + optional Supabase `clarity_budget` · PAT never sent to Supabase · `[portfolio/clarity-budget-web](portfolio/clarity-budget-web)`                                                                                                                             |
