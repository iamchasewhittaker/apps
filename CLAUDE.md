...
| Unnamed (web)               | v0.1          | `unnamed_v1`                                                                                                                  | local (deploy pending)              | ✅ Active · Daily OS for ADHD brains · **Web/iOS parity reconciled (2026-04-24)** · Next.js + Tailwind 4 + localStorage · Phase 1: 7-day rule · Vercel deploy queued · `[portfolio/unnamed](portfolio/unnamed)` |
