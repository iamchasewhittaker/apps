...
| Clarity Budget (iOS)        | v0.1          | `chase_budget_ios_v1` + YNAB Keychain `com.chasewhittaker.ClarityBudget`                                                                                                        | local Xcode                         | ✅ Phase 4 + **YNAB import & PATCH fund** · `**docs/BRANDING.md` + AppIcon** · xcodeproj (`CB*`) · `[portfolio/clarity-budget-ios](portfolio/clarity-budget-ios)` · dual-scenario + wants + YNAB settings (toolbar)                                   |
