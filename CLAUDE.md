...
| Job Search HQ               | v8.17         | `chase_job_search_v1`                                                                                                        | job-search-hq.vercel.app            | ✅ Active · v8.17 Daily Flow Option E (Morning Launchpad — 3-stage soft-gated daily flow Discover → Apply → Outreach, ~80 min, derived from existing data, Sunday rest mode; `getLaunchpadProgress` helper) · v8.16 Discovery Sprint + Apply Wizard · v8.15 TargetCompanyBoard · v8.14 Today's 5 + Outreach Autopilot · Confidence Bedrock · Wave 4 #1–#6 all shipped · Chrome MV3 in `extension/`                |
