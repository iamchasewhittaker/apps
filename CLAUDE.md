...
| Clarity Budget (iOS) | v0.1 | `chase_budget_ios_v1` | local Xcode | 🔲 Phase 4 — HANDOFF stub · [`portfolio/clarity-budget-ios`](portfolio/clarity-budget-ios) · dual-scenario budget + wants |
