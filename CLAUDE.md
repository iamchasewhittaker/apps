...
| Clarity Budget (web)        | v0.3          | `chase_budget_web_v1` + `chase_budget_web_tx_v1` (tx cache) + YNAB token key in `localStorage`                                                                                          | local                               | ✅ Session 1 done · STS dashboard + **transaction fetch** (60d) + **spending breakdown** (top-8 categories) · tx never synced to Supabase · Session 2 next: filters + list · `[portfolio/clarity-budget-web](portfolio/clarity-budget-web)`                                              |
...
| Job Search HQ               | v8.9          | `chase_job_search_v1`                                                                                                        | job-search-hq.vercel.app            | ✅ Active · Wave 4 #2: Draft Message contact nav · Weekly Review tab · Chrome MV3 in `extension/`                                                                                                                         |
...
| Growth Tracker              | v6            | `chase_growth_v1`                                                                                                            | local                               | ✅ Active · `[portfolio/growth-tracker](portfolio/growth-tracker)`                                                                                                                                                       |
| Money                       | v0.1          | `chase_money_v1`                                                                                                             | local                               | ✅ Active · Transaction Enricher + Budget Dashboard · superseded by Spend Clarity · `[portfolio/money](portfolio/money)`                                                                                                 |
...
| Knowledge Base              | v2.1.0        | `chase_knowledge_base_v1`                                                                                                    | local                               | ✅ Active · favicons on bookmark rows/home cards · Export/Import JSON in sidebar footer · `[portfolio/knowledge-base](portfolio/knowledge-base)`                                                                         |
