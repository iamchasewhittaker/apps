# Portfolio monorepo — AI coding rules (Gemini)
...
- **New chat:** paste from `docs/templates/SESSION_START_MONOREPO.md` or paste `CLAUDE.md` intro + `HANDOFF.md` State table into your context.
