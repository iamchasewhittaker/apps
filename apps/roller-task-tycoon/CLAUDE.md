...
- **Portfolio copy** of [`/apps/shared/sync.js`](../../shared/sync.js) at `src/shared/sync.js` (real file, not symlink — Vercel-safe)
...
src/
  ...
  shared/sync.js           — copy of apps/shared/sync.js
docs/
