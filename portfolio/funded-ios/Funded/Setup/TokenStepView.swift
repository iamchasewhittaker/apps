...
struct TokenStepView: View {
    ...
    private var instructionCard: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            Text("Get it at app.ynab.com → Account Settings → Developer Settings → New Token. Prefer a token used only for Funded (you can create a separate token for Clarity Budget iOS). This stays on your device in the secure Keychain — never stored anywhere else.")
