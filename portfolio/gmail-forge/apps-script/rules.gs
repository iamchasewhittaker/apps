...
var RULES = {
  ...
  'Notification': {
    ...
    addresses: [
      ...
      'CustomerExperience@email.vivint.com',
      'ourcustomers@customers.libertymutual.com',
    ],
    toAliases: [],
  },
  ...
  'Marketing': {
    domains: [
      ...
      'mail.grammarly.com',
      'yardmastery.com',
      'p.rocketmortgage.com',
      'e.rocketloans.com',
      'email.chipotle.com',
      'jetpens.com',
      'marketing.zerolongevity.com',
      'craighill.co',
      'team.public.com',
      'info.rockymountainpower.net',
      'bespokepost.com',
    ],
    addresses: [],
    toAliases: [],
