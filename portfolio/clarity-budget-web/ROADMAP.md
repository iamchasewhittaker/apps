...
> **v1 Redesign in progress.** Phase 2 (Money Companion) deferred. Active plan: `plans/clarity-budget-web-redesign.md` (10 steps). Progress: Steps 1–8 ✅ done. **2026-04-30: Shipyard glass theme alignment shipped** — dashboard now matches Shipyard's square stat grid, simplified heading, and `rounded-xl` consistency. Accent stays green. Step 9 (split `HomeDashboard.tsx`) is next.
>
