...
**Description:** Replace-all import from `ParkChecklist-backup-*.json`, `schemaVersion` 1 only, confirmed by user. **Linear:** [WHI-15](https://linear.app/whittaker/issue/WHI-15).
