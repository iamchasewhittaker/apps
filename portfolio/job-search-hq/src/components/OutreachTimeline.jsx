...
const date = { fontSize: 11, color: T.muted, fontVariantNumeric: "tabular-nums" };
const typeText = (color) => ({ fontSize: 12, color, fontWeight: 600 });
const method = { fontSize: 11, color: T.muted };
const notes = { fontSize: 12, color: T.foreground, marginTop: 1, lineHeight: 1.4, wordBreak: "break-word" };
const empty = { fontSize: 12, color: T.muted, fontStyle: "italic" };
