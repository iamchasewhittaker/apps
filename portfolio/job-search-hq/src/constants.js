...
// ── STYLES ────────────────────────────────────────────────────────────────────
export const s = {
  root: { minHeight: "100vh", background: T.bgGradient, color: T.foreground, fontFamily: "'Instrument Sans', system-ui, sans-serif" },
  header: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "24px 24px 0", gap: 12, flexWrap: "wrap" },
  headerTitle: { fontSize: 22, fontWeight: 700, color: T.foreground, letterSpacing: "-0.5px", fontFamily: "'Big Shoulders Display', sans-serif" },
  ...
  focusCountNum: { fontSize: 24, fontWeight: 700, color: T.success, fontFamily: "'Big Shoulders Display', sans-serif" },
  focusCountLabel: { fontSize: 11, color: T.muted, fontFamily: "'DM Mono', monospace", textTransform: "uppercase", letterSpacing: "0.08em" },
  ...
  statNum: { fontSize: 20, fontWeight: 700, color: T.foreground, fontFamily: "'Big Shoulders Display', sans-serif" },
  statLabel: { fontSize: 11, color: T.muted, marginTop: 2, fontFamily: "'DM Mono', monospace", textTransform: "uppercase", letterSpacing: "0.08em" },
  // Contact filters
  ...
  sectionLabel: { fontSize: 12, fontWeight: 600, color: T.muted, textTransform: "uppercase", letterSpacing: "0.08em", fontFamily: "'DM Mono', monospace" },
  profileSectionLabel: { fontSize: 11, fontWeight: 700, color: T.muted, textTransform: "uppercase", letterSpacing: "0.08em", marginTop: 8, paddingTop: 8, borderTop: `1px solid ${T.border}`, fontFamily: "'DM Mono', monospace" },
  ...
  resultText: { padding: 12, fontSize: 14, color: T.successTextLight, whiteSpace: "pre-wrap", wordBreak: "break-word", maxHeight: 400, overflowY: "auto", margin: 0, fontFamily: "'DM Mono', monospace" },
  ...
  baseResumePreview: { background: T.cardSubtle, border: `1px solid ${T.border}`, borderRadius: 8, padding: 12, fontSize: 14, color: T.muted, whiteSpace: "pre-wrap", wordBreak: "break-word", maxHeight: 400, overflowY: "auto", margin: 0, fontFamily: "'DM Mono', monospace" },
  ...
  aqLabel: { fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.08em", padding: "2px 7px", borderRadius: 6, whiteSpace: "nowrap", flexShrink: 0, fontFamily: "'DM Mono', monospace" },
  ...
  urgencyBadge: { fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.08em", padding: "2px 7px", borderRadius: 6, whiteSpace: "nowrap", flexShrink: 0, fontFamily: "'DM Mono', monospace" },
  ...
  discoveryQueryLabel: { fontSize: 10, fontWeight: 700, color: T.muted, textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 4, fontFamily: "'DM Mono', monospace" },
  ...
  discoveryCaptureLabel: { fontSize: 11, fontWeight: 600, color: T.muted, textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 6, fontFamily: "'DM Mono', monospace" },
  ...
  wizStepLabel: { fontSize: 11, fontWeight: 700, color: T.muted, textTransform: "uppercase", letterSpacing: "0.08em", padding: "0 20px 6px", fontFamily: "'DM Mono', monospace" },
  ...
  launchpadSub: { fontSize: 11, color: T.muted, letterSpacing: "0.08em", fontFamily: "'DM Mono', monospace" },
  ...
  launchpadStageBadge: { fontSize: 12, fontWeight: 700, color: T.muted, background: T.card, borderRadius: 999, padding: "2px 8px", letterSpacing: "0.08em", fontFamily: "'DM Mono', monospace" },
  ...
  inboxSub: { fontSize: 11, color: T.muted, letterSpacing: "0.08em", fontFamily: "'DM Mono', monospace" },
  ...
  inboxKindBadge: { fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.08em", padding: "2px 7px", borderRadius: 6, whiteSpace: "nowrap", flexShrink: 0, fontFamily: "'DM Mono', monospace" },
...
export const css = `
  @import url('https://fonts.googleapis.com/css2?family=Instrument+Sans:wght@400;700&family=Big+Shoulders+Display:wght@700&family=DM+Mono&display=swap');
