  ...
  return (
    <ErrorBoundary name="Resources">
      <div style={s.content}>
        ...
        <div style={{ marginBottom: 24, padding: "14px 16px", background: T.card, border: `1px solid ${T.border}`, borderRadius: 12 }}>
          <div style={{ ...s.sectionLabel, color: T.highlight, marginBottom: 8 }}>Chrome extension (MVP)</div>
          <div style={{ fontSize: 14, color: T.foreground, lineHeight: 1.55, marginBottom: 10 }}>
            Load the unpacked extension from the repo folder <code style={{ fontSize: 14, color: T.highlightLight }}>extension/</code> — capture LinkedIn profiles and job postings into this app, and show an Action Queue badge while Job Search HQ is open. Full steps: see <code style={{ fontSize: 14, color: T.highlightLight }}>extension/README.md</code> in the project (clone / monorepo).
          </div>
        </div>
        ...
        <div style={{ marginTop: 8, padding: "16px 18px", background: T.cardSubtle, border: `1px solid ${T.border}`, borderRadius: 12 }}>
          <div style={{ fontSize: 14, fontWeight: 700, color: T.backupOrange, marginBottom: 4 }}>💾 Data Backup</div>
