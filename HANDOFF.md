...
| **Focus**      | **Portfolio promotion (2026-04-14).** Moved AI Dev Mastery, Shortcut Reference, Claude Usage Tool from `projects/` to `portfolio/` as active apps. Full doc scaffolding, Cursor symlinks, Linear projects. Prior: Clarity Command iOS shipped; Job Search HQ iOS v0.1 scaffold + device install. |
| **Next**       | 1. **Sprint 1 setup in Linear UI** — create cycle 2026-04-21 to 2026-05-04, assign WHI-42 (8pt) + WHI-23 (2pt) + WHI-35 (2pt) + WHI-49 (1pt) = 13 pts. 2. **TrackerTab split (WHI-42)** — break 1420-line monolith into morning/evening sub-components. 3. Deploy AI Dev Mastery to Vercel. 4. Assess Claude Usage Tool scraper health. 5. Define Shortcut Reference V1 scope. |
| **Blockers**   | None. |
| **Last touch** | 2026-04-14 — **Portfolio promotion:** AI Dev Mastery + Shortcut Reference + Claude Usage Tool moved to `portfolio/`, full doc scaffolding, Linear projects. Prior: YNAB Clarity Web deploy; Job Search HQ iOS v0.1; Clarity Command iOS v0.1. |
