...
| **Blockers**   | *(none)*                                                                                                                                                                                                                                                                   |
| **Last touch** | 2026-04-13 — **Clarity Time** AppIcon + wide mockup swapped to **user-selected clock** asset (`docs/design/app-icon-source-user-1024.png`); `xcodebuild build` ClarityTime ✅; root `ROADMAP` row updated. Earlier: Triage chevron + Time first ship.                                                                                                                                                                                      |
