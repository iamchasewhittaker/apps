...
| **Next**       | 1. **Fairway iOS:** field walk — open audit sheet per head, enter arc/radius/nozzle/GPM, tick "Head cleared". 2. **Fairway iOS:** visually verify map zone-hulls separate Z3 NW pins from Z4 cluster on device. 3. **Fairway iOS:** seed actions for Z2 phase0 problem more granularly post-audit. 4. **clarity-budget-web Session 3** — Claude money companion. 5. **Wellness:** split TrackerTab.jsx (WHI-63). |
