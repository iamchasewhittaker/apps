...
| **Next**       | Job Search HQ Wave 2: use [`docs/templates/SESSION_START_JOB_SEARCH_WAVE2.md`](docs/templates/SESSION_START_JOB_SEARCH_WAVE2.md). Logo rollout: ✅ complete — all 3 apps done. |
| **Blockers**   | *(none)*                                                                                                                                                                                                                                                                   |
